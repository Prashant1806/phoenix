...
if(file_exists($fileName))
{
	...
	$email_from = "PhoenixScan@gmail.com"; // Who the email is from, don't think this does anything
	$email_subject = "PhoenixScan Detailed Report"; // The Subject of the email 
	$email_message = "Hello $username,<br><br>";
	$email_message .= 'Thank you for scanning with PhoenixScan. Please find the scan results attached in the PDF report.<br><br>';
	$email_message .= 'Please reply to this email if you have any questions.<br><br>';
	$email_message .= 'Kind Regards,<br><br>';
	$email_message .= 'PhoenixScan Team<br>';
