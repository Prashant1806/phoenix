...
<div id="header">
  <div class="center">
    <div id="logo"><a href="#">Phoenix</a></div>
    <!--Menu Begin-->
	<div id="menu">
...
<div id="bottomrow">
  <div class="textbox">
    <h1>Phoenix - The Web Application Vulnerability Scanner</h1>
    <p>Phoenix firstly crawls the target website to identify all URLs belonging to the website. It tests each URL for a number of vulnerabilities and emails you a detailed PDF report once the scan is complete.</p></div>
</div>
<!--BottomRow END-->
<!--Footer Begin-->
<div id="footer">
  <div class="foot"> <span>The Product</span> by <a href="http://www.therdgroupofindustries.com">Phoenix.</a> is licensed under a <a href="http://creativecommons.org/licenses/by/3.0/">Creative Commons Attribution 3.0 Unported License.</a> </div>
</div>
<!--Footer END-->
</body>
</html>
